...
public partial class RFModel
{
    ...
    public static OutputRec Predict(ModelInput input)
    {
        var predEngine = PredictEngine.Value;
        var rec = predEngine.Predict(input);
        var recc = new OutputRec();
        recc.Recommendations = rec.Score > 0 ? "Fraud Case" : "Normal and Correct Case";
        return recc;
    }
